fluidPage(
  tags$head(
    tags$title("App Name"),
    tags$link(rel = "shortcut icon", href = "images/tychobra-icon-blue.png"),
    tags$style("
        .auth_panel {
          width: 350px;
          max-width: 100%;
  ...
  fluidRow(
    ...
    column(
      width = 5,
      offset = 2,
      style = "background-image: url('images/workchat.svg');  background-repeat: no-repeat; background-size: contain; height: 550px",
      br(),
      br(),
      h1(
